        ...
        public partial class NullableOptional_Tests
        {
            public partial class BlogPost
            {
                public static Result<BlogPost> MapFromJson(JsonElement jsonElement, MapperOptions mapperOptions = null, string[] path = null)
                {
                    ...
                    var p_Status = default(FartingUnicorn.Option<FartingUnicorn.Tests.SingleField.EnumType.NullableOptional_Tests.BlogPost.BlogPostStatus>?);
                    ...
                    if (isStatusPropertyDefined)
                    {
                        ...
                        {
                            p_Status = new None<FartingUnicorn.Tests.SingleField.EnumType.NullableOptional_Tests.BlogPost.BlogPostStatus>();
                        }
                        else if (mapperOptions.TryGetConverter(typeof(FartingUnicorn.Tests.SingleField.EnumType.NullableOptional_Tests.BlogPost.BlogPostStatus), out IConverter customConverter))
                        {
                            ...
                            else
                            {
                                ...
                                if (result.Success)
                                {
                                    p_Status = new Some<FartingUnicorn.Tests.SingleField.EnumType.NullableOptional_Tests.BlogPost.BlogPostStatus>(result.Map(x => (FartingUnicorn.Tests.SingleField.EnumType.NullableOptional_Tests.BlogPost.BlogPostStatus)x).Value);
                                }
                                else
                                {
