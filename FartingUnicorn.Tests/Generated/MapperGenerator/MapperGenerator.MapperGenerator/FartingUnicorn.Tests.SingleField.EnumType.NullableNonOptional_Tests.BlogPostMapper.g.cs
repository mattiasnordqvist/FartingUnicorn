...
// Property 0
// Name: Status
// CompleteType: FartingUnicorn.Tests.SingleField.EnumType.NullableNonOptional_Tests.BlogPost.BlogPostStatus?
// IsArray: False
// IsObject: False
// IsNullable: True
// IsOption: False
// RawType: FartingUnicorn.Tests.SingleField.EnumType.NullableNonOptional_Tests.BlogPost.BlogPostStatus
        ...
        public partial class NullableNonOptional_Tests
        {
            public partial class BlogPost
            {
                public static Result<BlogPost> MapFromJson(JsonElement jsonElement, MapperOptions mapperOptions = null, string[] path = null)
                {
                    ...
                    var p_Status = default(FartingUnicorn.Tests.SingleField.EnumType.NullableNonOptional_Tests.BlogPost.BlogPostStatus?);
                    ...
                    if (isStatusPropertyDefined)
                    {
                        ...
                        else if (mapperOptions.TryGetConverter(typeof(FartingUnicorn.Tests.SingleField.EnumType.NullableNonOptional_Tests.BlogPost.BlogPostStatus), out IConverter customConverter))
                        {
                            ...
                            else
                            {
                                ...
                                if (result.Success)
                                {
                                    p_Status = result.Map(x => (FartingUnicorn.Tests.SingleField.EnumType.NullableNonOptional_Tests.BlogPost.BlogPostStatus)x).Value;
                                }
                                else
                                {
